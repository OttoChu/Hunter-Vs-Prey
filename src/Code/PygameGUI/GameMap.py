...
# TODO: Might need to use a separate thread to generate the map to prevent the GUI from freezing
#       The main thread should show a loading screen while the map is being generated
...
class GameMap():
    ...
    def is_mountain(self, position: tuple) -> bool:
        ...
        """
        return self.game_map[position[1]][position[0]] == M

    def update(self, old_position: tuple, new_position: tuple, animal_type: str) -> None:
        """
        ...
        """
        self.game_map[new_position[1]][new_position[0]] = animal_type
        self.game_map[old_position[1]][old_position[0]] = T